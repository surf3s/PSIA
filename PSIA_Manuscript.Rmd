...
knitr::opts_chunk$set(tidy = FALSE, echo = FALSE, warning = FALSE, message = FALSE, comment = NA)
...
if (tiff_figures) {
  ...
  tiff('figure_01.tif', res = 300, width = 5, height = 2, units = 'in') }
...
```{r fig2-dibble_psia_histogram, fig.cap = "Distribution of estimated PSIA based on the Dibble glass flakes.", fig.width = 5, fig.height = 2.5}

maincolumn_width_theme = theme(text = element_text(size = 10))

#plot_angles = data.frame(psia = psia)
...
if (tiff_figures) {
    ...
    tiff('figure_02.tif', res = 300, width = 5, height = 2.5, units = 'in') }
...
Figure 2 shows the distribution of estimated PSIA in the Dibble glass dataset.  The distribution has a mean of `r round(mean(psia),2)`±`r round(sd(psia),2)`.  Variation in this angle does not seem to be related to platform depth, exterior platform angle or weight (Figure 3).  There is a relationship between platform width and the platform surface interior angle such that larger angles result in wider platforms, which is to be expected (see Figure 3).  

```{r fig3-psia_to_other_flake_measures, fig.cap = "PW, PD, EPA and weight against the estimated PSIA based on the Dibble glass flakes.", fig.width = 5}
...
p2 = p2 + my_theme + theme(axis.text.y=element_blank())
...
p4 = p4 + my_theme + theme(axis.text.y=element_blank())

if (tiff_figures) {
    cat('[place Figure 3 here]')
    tiff('figure_03.tif', res = 300, width = 5, height = 4, units = 'in') }
...
```{r fig4-AOB_to_PSIA, fig.height = 2.5, fig.width = 4, fig.cap = "AOB against the estimated platform surface interior angles based on the Dibble glass flakes."}
...
if (tiff_figures) {
    ...
    tiff('figure_04.tif', res = 300, width = 4, height = 2.5, units = 'in') }
...
p = p + geom_point(size = .65, alpha = .65)
...
if (tiff_figures) {
    ...
    tiff('figure_05.tif', res = 300, width = 5, height = 2.5, units = 'in') }
...
```{r fig6_remeasure_comparisons, fig.height = 2, fig.width = 6.5, fig.cap = "A comparison of the estimated platform surface interior angle, this same angle as calculated from caliper measurements, and this same angle measured with a goniometer.  All measures are in degrees."}
...
if (tiff_figures) {
    ...
    tiff('figure_06.tif', res = 300, width = 6.5, height = 2, units = 'in') }
...
```{r fig7_remeasure_distributions, fig.height = 2.5, fig.width = 6.5, fig.cap = 'The distributions of platform surface interior angle as directly measured with a goniometer and as calculated from caliper measurements.'}
...
if (tiff_figures) {
    ...
    tiff('figure_07.tif', res = 300, width = 6.5, height = 2.5, units = 'in') }
...
if (tiff_figures) {
    ...
    tiff('figure_08.tif', res = 300, width = 5, height = 2.5, units = 'in') }
...
p = p + geom_point(show.legend = FALSE, size = .35, alpha = .65)
p = p + xlab('PSIA')
...
if (tiff_figures) {
    ...
    tiff('figure_09.tif', res = 300, width = 5, height = 2, units = 'in') }
...
if (tiff_figures) {
    ...
    tiff('figure_10.tif', res = 300, width = 5, height = 2.5, units = 'in') }
...
if (tiff_figures) {
    ...
    tiff('figure_11.tif', res = 300, width = 5, height = 5, units = 'in') }
